...
import com.example.fussionv3.Search.FilterCategory;
import com.example.fussionv3.TopicListUserActivity;
import com.example.fussionv3.databinding.RowCategoryBinding;
...
public class AdapterCategory extends RecyclerView.Adapter<AdapterCategory.HolderCategory> implements Filterable {
    ...
    public void onBindViewHolder(@NonNull AdapterCategory.HolderCategory holder, int position) {
        ...
        // handle item click, goto TopicListUserActivity, else pass topic category and categoryId
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(context, TopicListUserActivity.class);

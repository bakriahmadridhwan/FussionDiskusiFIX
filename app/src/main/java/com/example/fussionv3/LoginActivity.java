...
import com.example.fussionv3.databinding.ActivityLoginBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.tVlupaPassword.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                FancyToast.makeText(LoginActivity.this, "Belum Tersedia !", FancyToast.LENGTH_LONG, FancyToast.WARNING, true).show();
            }
        });
    }
